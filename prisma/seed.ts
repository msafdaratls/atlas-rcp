    ...
    checkSets: [
      {
        ...
        { code: "RULE-GSO1943-5.9-01", titleEn: "Labeling - Ingredient Listing (INCI)", titleAr: "قائمة المكونات (INCI)", priority: "Critical" },
        ...
        { code: "RULE-GSO1943-6.4-01A", titleEn: "Mandatory warnings for glass ampules and vials in Arabic and English.", titleAr: "تحذيرات إلزامية للأمبولات والقوارير الزجاجية", priority: undefined },
        ],
      },
      ...
      // not invented, so the gap stays visible to whoever reviews these.
      {
        ...
        items: [
          ...
          { code: "CLAIM-GEN-1-2", titleEn: "Is the function limited to the cosmetic purposes (cleaning, perfuming, changing appearance, protecting, keeping in good condition, correcting body odors)?", titleAr: "هل الوظيفة تقتصر على الأغراض التجميلية الخمسة؟" },
