...
export default async function CosmeticsDatasetsPage({ params }: Props) {
  ...
  const versions = (await listKbVersions("COSMETICS")) ?? [];
  ...
  return (
    <div>
      ...
      />
      <KbDatasetsPanel domain="COSMETICS" versions={versions} />
    </div>
  );
}
