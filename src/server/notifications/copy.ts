...
const CATALOG: Record<NotificationCopyKey, NotificationCopy> = {
  ...
  INVOICE_ISSUED: {
    ...
    bodyEn: "Pro forma invoice {invoiceNo} for {requestNo}.",
    bodyAr: "فاتورة مبدئية {invoiceNo} للطلب {requestNo}.",
  ...
  PAYMENT_RECEIVED: {
    ...
    bodyEn: "A payment was confirmed.",
    bodyAr: "تم تأكيد دفعة.",
    ctaLabelEn: "View statement",
    ctaLabelAr: "عرض كشف الحساب",
  },
  PAYMENT_REJECTED: {
    ...
    bodyEn: "Your payment was rejected: {reason}",
    bodyAr: "تم رفض دفعتك: {reason}",
    ctaLabelEn: "View statement",
    ctaLabelAr: "عرض كشف الحساب",
  },
  SLA_AT_RISK: {
  ...
  STATEMENT_OVERDUE: {
    ...
    bodyEn: "Pro forma invoice {invoiceNo} is past due.",
    bodyAr: "الفاتورة المبدئية {invoiceNo} متأخرة.",
    ctaLabelEn: "View statement",
    ctaLabelAr: "عرض كشف الحساب",
  },
  REOPEN_REQUESTED: {
